...
namespace AirlineReservtionSystem
{
    ...
    public partial class RoundTrip : Form
    {
        ...
        public static string id1, aname, dep, arr, dur;
        string temp;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            FinalBooking1 fb = new FinalBooking1();
            fb.ShowDialog();
            this.Close();
        }

        private void RoundTrip_Load(object sender, EventArgs e)
        {
